      ...
      <div className="flex h-16 items-center px-6 gap-4">
        ...
        <div className="ml-auto flex items-center space-x-4 relative">
          <div className="relative">
            ...
            {searchOpen && results && (
              <div className="absolute z-50 mt-2 left-0 sm:right-0 sm:left-auto w-[32rem] max-w-[95vw] max-h-[65vh] overflow-auto bg-background border border-border rounded-md shadow-lg ring-1 ring-border">
